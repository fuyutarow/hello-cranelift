...
use uzi::disasm::print_all;
use uzi::utils::read_to_string;
...
pub fn main() -> Result<()> {
    ...
    dbg!(&options);
    // options.target = "x86_64-android".to_string();
...
//     let path = Path::new("add.clif");
//     let name = "okmaru";
//     let
//     handle_module(&options, path, name, fisa, module)
// }
